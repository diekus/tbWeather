...
ICON_DATA = {
    "clear": "iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMCAIAAADZF8uwAAAAKUlEQVR42mNgIBX8P4NAhFVgV4epAl0dLhUo6oisCCiHExsExAYmHgAAf1KIRduvd3gAAAAASUVORK5CYII=",
    ...
    "thunderstorm": "iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMCAIAAADZF8uwAAAAMklEQVR42mNgIAl4h2aiIcIq0NXhUoFQh18FVB1RitDA/9dGEITTgySowKcIro6BhgAAxitLAaxNUAcAAAAASUVORK5CYII=",
...
def render_error():
    """ERROR state — shown when the API call fails or data is missing."""
    return render.Root(
        child = render.Box(
            width  = DISPLAY_W,
            height = DISPLAY_H,
